...
pub const N2AS_A: [f64; COMPARTMENTS] = [
    1.2599, 1.0000, 0.8618, 0.7562, 0.6667, 0.5933, 0.5282, 0.4701, 0.4187, 0.3798, 0.3497, 0.3223,
    0.2971, 0.2737, 0.2523, 0.2327,
];
pub const N2AS_B: [f64; COMPARTMENTS] = [
    1.2599, 1.0000, 0.8618, 0.7562, 0.6667, 0.5600, 0.4947, 0.4500, 0.4187, 0.3798, 0.3497, 0.3223,
...
pub const HALF_TIMES_N2: [f64; COMPARTMENTS] = [
    4.00, 8.00, 12.50, 18.50, 27.00, 38.30, 54.30, 77.00, 109.00, 146.00, 187.00, 239.00, 305.00,
    390.00, 498.00, 635.00,
]; // 1b 5.0
